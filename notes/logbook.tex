...
\begin{figure}[htbp]
\centering
\includegraphics{../plots/4pamdecisionerror.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{../plots/opt_dec_reg_analytic.png}
...
Dave produced an analytical solution for the optimum decision region
...
During an email conversation with Dave, he suggested that the
...
In this week I examined Dave's derivation and modeling of the non-fading
...
A brief email exchange with Dave helped me understand the source of the
