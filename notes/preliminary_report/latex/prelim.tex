...
is believed this behavior can be generalised to L-PAM signalling. \marginpar{By \emph{L-PAM} I mean PAM signalling with an arbitrary number L of possible symbols. L=4 reduces to 4-PAM, and L=2 reduces to BPSK.} This
will serve as a foundation from which to explore the effects of a
non-deterministic timing offset in more general cases.

\ctparttext{A plan of work for Teaching Period 2, and a brief discussion of ethical issues relating to the project.} 
